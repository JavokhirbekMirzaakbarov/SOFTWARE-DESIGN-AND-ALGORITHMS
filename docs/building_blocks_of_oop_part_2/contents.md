...
- [2. Duck Typing](/docs/building_blocks_of_oop_part_2/duck_typing)
  - [2.1 If It Walks Like a Duck and Talks Like a Duck Then It’s a Duck](/docs/building_blocks_of_oop_part_2/duck_typing#21-if-it-walks-like-a-duck-and-talks-like-a-duck-then-its-a-duck)
