...
<TableForMentors data={[
  {
    ...
    items: [
      {
        text: "Examples of SOLID and violations of it are found for two principles",
        points: 1,
      },
      {
        text: "Examples of SOLID and violations of it are found for three principles",
        points: 1,
      },
      {
        text: "Examples of SOLID and violations of it are found for four principles",
        points: 1,
      },
      {
        text: "Examples of SOLID and violations of it are found for five principles",
        points: 1,
      },
    ]
  },
